...
- [x] 09-03-PLAN.md — YouTube Live API setup plus FFmpeg egress start/stop/status lifecycle
- [x] 09-04-PLAN.md — Dashboard plugin panel, YouTube controls, and share metadata UI

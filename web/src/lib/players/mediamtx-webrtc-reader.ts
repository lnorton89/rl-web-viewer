// @ts-nocheck
// Vendored from MediaMTX v1.17.1:
// https://github.com/bluenviron/mediamtx/blob/v1.17.1/internal/servers/webrtc/reader.js
...
export class MediaMTXWebRTCReader {
   ...
   * @param {MediaMTXWebRTCReaderConfig} conf - configuration.
   */
  constructor(conf) {
